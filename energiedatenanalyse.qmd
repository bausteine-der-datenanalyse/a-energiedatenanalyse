...
**Stellen Sie den Jahresgang des Stromverbrauchs durch Pumpspeicher in Österreich 2023 dar.** Hinweise zum Herunterladen der Daten finden Sie in Abschnitt [@sec-aufgabe-beschreibende-Datenanalyse].
...
erzeugung_aut = pd.read_csv(filepath_or_buffer = "skript/01-daten/AGPT_2022-12-31T23_00_00Z_2023-12-31T23_00_00Z_15M_de_2024-06-10T09_32_38Z.csv",
                            sep = ";", decimal = ",", thousands = ".")

# string replace & als Datum einlesen
## Spalte Zeit von [CET/CEST]
erzeugung_aut['Zeit von [CET/CEST]'] = erzeugung_aut['Zeit von [CET/CEST]'].str.replace(pat = '2A', repl = '02')
erzeugung_aut['Zeit von [CET/CEST]'] = erzeugung_aut['Zeit von [CET/CEST]'].str.replace(pat = '2B', repl = '02')

erzeugung_aut['Zeit von [CET/CEST]'] = pd.to_datetime(erzeugung_aut['Zeit von [CET/CEST]'], format = "%d.%m.%Y %H:%M:%S")

## Spalte Zeit bis [CET/CEST]
erzeugung_aut['Zeit bis [CET/CEST]'] = erzeugung_aut['Zeit bis [CET/CEST]'].str.replace(pat = '2A', repl = '02')
erzeugung_aut['Zeit bis [CET/CEST]'] = erzeugung_aut['Zeit bis [CET/CEST]'].str.replace(pat = '2B', repl = '02')

erzeugung_aut['Zeit bis [CET/CEST]'] = pd.to_datetime(erzeugung_aut['Zeit bis [CET/CEST]'], format = "%d.%m.%Y %H:%M:%S")

print(erzeugung_aut.dtypes)
