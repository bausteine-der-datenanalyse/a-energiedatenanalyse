...
Eine vollständige Deckung der Netzlast durch erneuerbare Stromerzeugung ist nur selten der Fall. Zumeist ist die Restlast größer Null. Somit ist bereits durch die graphische Darstellung zu vermuten, dass die Pumpspeicher überwiegend durch nicht erneuerbare Stromerzeuger befüllt werden. Ob dies auch tatächlich der Fall ist, wird in der weiteren Analyse geprüft.
...
**f-string Formatierung .2f geht leider nicht mit pd.Series: TypeError: unsupported format string passed to function .__format__**  
...
**Überraschend läuft eigentlich kein Erzeuger in Grundlast, sondern die bedeutenden konventiellen Erzeuger werden mit Ausnahme der Kernergie mehr oder weniger wie Erdgas im Lastfolgebetrieb gefahren. Der Grundlastbetrieb ist 2023, streng wissenschaftlich gesprochen, tot!**  
