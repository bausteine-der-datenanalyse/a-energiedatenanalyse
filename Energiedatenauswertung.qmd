...
Die Restlast kann ebenfalls mit den vorliegenden Daten als Differenz aus Stromverbrauch und Erzeugung durch Erneuerbare bestimmt werden.
...
Die selbst errechnete Restlast ist kleiner als die von der Bundesnetzagentur veröffentlichte Residuallast. Die Ursache hierfür ist, dass die Residuallast definiert ist als:
...
Allerdings sind aus technischen oder aus wirtschaftlichen Gründen nicht alle Erzeuger gleichermaßen für den Lastfolgebetrieb geeignet. 
...
Welche Erzeugungsleistung nehmen wir... erst mal gucken, ob Pumpspeicher gleichzeitig ein- und ausspeisen (sollte nicht so sein, ist aber möglich, wegen Regelzonen.)
    ...
    - Vorbereitung 1: Restlast bestimmen
      ...
      - Herkunft Pumpspeicherenergie top-down abschätzen: in wie vielen Intervallen war die Restlast negativ
